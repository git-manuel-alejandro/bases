// To parse this data:
//
//   import { Convert, GiphyInterface } from "./file";
//
//   const giphyInterface = Convert.toGiphyInterface(json);
//
...
export class Convert {
    public static toGiphyInterface(json: string): GiphyInterface {
        return cast(JSON.parse(json), r("GiphyInterface"));
    }

    public static giphyInterfaceToJson(value: GiphyInterface): string {
        return JSON.stringify(uncast(value, r("GiphyInterface")), null, 2);
    }
}
